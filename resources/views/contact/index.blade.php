            ...
            <tbody>
                @forelse($contacts as $contact)
                    <tr>
                        ...
                        <td>
                            <a
                                href="{{ route('contacts.edit', $contact->id) }}"class="btn btn-sm btn-pill btn-outline-tertiary">Edit</a>
                            <button class="btn btn-danger mt-2 animate-up-2" type="button" data-bs-toggle="modal"
								...
								<div class="modal fade" id="modal-delete-{{ $contact->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-default"
								aria-hidden="true">
